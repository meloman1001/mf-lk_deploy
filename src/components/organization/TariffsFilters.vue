   ...
   <div class="PackagesFilters">
      ...
      <form @submit.prevent="submit">
         ...
         <label class="label-input">
            <span>Продукт</span>
            <b-select :value="0" :options="products"></b-select>
         </label>

         <label class="label-input">
            <span>Регион</span>
            <b-select :value="0" :options="regions"></b-select>
         </label>
...
export default {
   ...
   data() {
      return {
         products: [
            {value: 0, text: 'Все продукты'}
         ],
         regions: [
            {value: 0, text: 'Все регионы'}
         ],
         // area: [
         //    {value: 0, text: 'Все населенные пункты'}
         // ],
         // packages: [
         //    {value: 0, text: 'Название'}
         // ],
      }
   },
   methods: {

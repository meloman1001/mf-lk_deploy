<template>
   <div class="table-tariff PackageTable">
      ...
      <div class="attention">
         Отображается только первая 1000 из найденных пакетов
      </div>

      <div class="packages__title">
         Найденные пакеты XRM
      </div>
      ...
      <div class="pc">
         <div class="table-tariff__header">
            ...
            <p>Регион</p>
            <p>Нас. Пункт</p>
            <p class="PackageTable__delete">Добавить в исключения</p>
         </div>
         ...
         <div class="table-tariff__body">
            ...
            <div>
               <div class="table-tariff__body-head">
                  <p>Выгода года 50/185+ Пакет (2.0) + Выгода года TV 185+</p>
                  <p>Московская</p>
                  <p>Люберцы</p>
                  <p>
                     <label class="checkbox">
      ...
      <div class="mobile">
         <div class="table-tariff__header">
            <div>Пакет</div>
            <div class="PackageTable__delete">Добавить в исключения</div>
         </div>
         <div class="table-tariff__body">
            <div class="table-tariff__body-head">
               <div>Модем + LTE аварийный</div>
               <div>
                  <label class="checkbox">
                     <input type="checkbox"/>
                     <span></span>
            ...
            <div class="table-tariff__body-desc">
               ...
               <div>
                  ...
                  <div class="table-tariff__row">
                     <p>gm_discountid</p>
                     <p>23f2344r-wergh-g456-4564- 005576h67345</p>
                  </div>
         ...
         <div class="table-tariff__body">
            <div class="table-tariff__body-head">
               <div>Выгода года 50/185+ Пакет (2.0) + Выгода года TV 185+</div>
               <div>
                  <label class="checkbox">
                     <input type="checkbox"/>
                     <span></span>
